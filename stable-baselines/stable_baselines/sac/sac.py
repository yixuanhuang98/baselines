...
from baselines.fcn1.utils import Dataset
...
class SAC(OffPolicyRLModel):
    ...
    def learn(self, total_timesteps, num_init_random_rollouts, callback=None, seed=None,
        ...
        with SetVerbosity(self.verbose), TensorboardWriter(self.graph, self.tensorboard_log, tb_log_name, new_tb_log) \
            ...
            for step in range(total_timesteps):
                ...
                # save transition
                if step < num_init_random_rollouts:
                    dataset.add(obs[2:], obs, rescaled_action, new_obs, reward, done)
