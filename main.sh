...
xterm -e 'python -m baselines.linear.run_humanoid --seed=1 --reward_scale=0.1 --env=Hopper-v2 --model-path=model/linear_ho_1' &
xterm -e 'python -m baselines.linear.run_humanoid --seed=2 --reward_scale=0.1 --env=Hopper-v2 --model-path=model/linear_ho_2' &
xterm -e 'python -m baselines.linear.run_humanoid --seed=3 --reward_scale=0.1 --env=Hopper-v2 --model-path=model/linear_ho_3' &
xterm -e 'python -m baselines.linear.run_humanoid --seed=4 --reward_scale=0.1 --env=Hopper-v2 --model-path=model/linear_ho_4' &
xterm -e 'python -m baselines.linear.run_humanoid --seed=5 --reward_scale=0.1 --env=Hopper-v2 --model-path=model/linear_ho_5' &
wait
xterm -e 'python -m baselines.linear.run_humanoid --seed=1 --reward_scale=0.1 --env=Hopper-v2 --model-path=model/linear_ho_1 --num_timesteps=10 --play' &
xterm -e 'python -m baselines.linear.run_humanoid --seed=2 --reward_scale=0.1 --env=Hopper-v2 --model-path=model/linear_ho_2 --num_timesteps=10 --play' &
xterm -e 'python -m baselines.linear.run_humanoid --seed=3 --reward_scale=0.1 --env=Hopper-v2 --model-path=model/linear_ho_3 --num_timesteps=10 --play' &
xterm -e 'python -m baselines.linear.run_humanoid --seed=4 --reward_scale=0.1 --env=Hopper-v2 --model-path=model/linear_ho_4 --num_timesteps=10 --play' &
xterm -e 'python -m baselines.linear.run_humanoid --seed=5 --reward_scale=0.1 --env=Hopper-v2 --model-path=model/linear_ho_5 --num_timesteps=10 --play' &
#xterm -e 'python -m baselines.ppo1.run_humanoid --seed=1 --reward_scale=0.1 --env=Walker2d-v2 --model-path=model/mlp_wk_1 --num_timesteps=10 --play' &
#xterm -e 'python -m baselines.ppo1.run_humanoid --seed=2 --reward_scale=0.1 --env=Walker2d-v2 --model-path=model/mlp_wk_2 --num_timesteps=10 --play' &
#xterm -e 'python -m baselines.ppo1.run_humanoid --seed=3 --reward_scale=0.1 --env=Walker2d-v2 --model-path=model/mlp_wk_3 --num_timesteps=10 --play' &
#xterm -e 'python -m baselines.ppo1.run_humanoid --seed=4 --reward_scale=0.1 --env=Walker2d-v2 --model-path=model/mlp_wk_4 --num_timesteps=10 --play' &
