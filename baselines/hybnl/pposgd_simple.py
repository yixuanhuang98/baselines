...
def learn(env, policy_fn, *,
    ...
    np.savetxt('./baselines/hybnl/data/'+env_name+'_s'+str(seed)+'_r'+str(scale)+'_rew.txt',np.asarray(reward_list))
    np.savetxt('./baselines/hybnl/data/'+env_name+'_s'+str(seed)+'_r'+str(scale)+'_ts.txt',np.asarray(timestep_list))
