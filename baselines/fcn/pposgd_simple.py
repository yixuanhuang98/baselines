...
def learn(env, policy_fn, *,
    ...
    np.savetxt('./baselines/fcn/data/'+env_name+'_s'+str(seed)+'_r'+str(scale)+'_rew_sergbasic.txt',np.asarray(reward_list))
    np.savetxt('./baselines/fcn/data/'+env_name+'_s'+str(seed)+'_r'+str(scale)+'_ts_sergbasic.txt',np.asarray(timestep_list))
