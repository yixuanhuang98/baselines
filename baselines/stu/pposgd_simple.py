...
def learn(env, policy_fn, *,
    ...
    np.savetxt('./baselines/stu/data/'+env_name+'_s'+str(seed)+'_r'+str(scale)+'_rew_sserg.txt',np.asarray(reward_list))
    np.savetxt('./baselines/stu/data/'+env_name+'_s'+str(seed)+'_r'+str(scale)+'_ts_sserg.txt',np.asarray(timestep_list))
