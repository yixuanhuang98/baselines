...
def learn(env, policy_fn, *,
    ...
    ratio = tf.exp(pi.pd.logp(ac) - old_pi_pd.logp(ac)) # pnew / pold
    ...
    np.savetxt('./baselines/fcn2/data/'+env_name+'_s'+str(seed)+'_r'+str(scale)+'_rew.txt',np.asarray(reward_list))
    np.savetxt('./baselines/fcn2/data/'+env_name+'_s'+str(seed)+'_r'+str(scale)+'_ts.txt',np.asarray(timestep_list))
